# Generated at 2012-08-22 20:35:54
...
GCC_WARN_AS_ERROR = FALSE     # TRUE,FALSE


OP01_2G_ONLY = FALSE     # TRUE,FALSE


X_BOOTING = NONE     # 


FLASH_DRV_IN_BL = NONE     # NAND:NAND flash booting
                           # EMMC:flash booting
...
ORIGINAL_FLAVOR = RF9810    # 


ORIGINAL_PROJECT_NAME = MT6589_MD2_TDD128HSPA    # 
...
CUSTOM_DEBUG_MODULES = INIT NVRAM
  # Description:
...
GERAN_RELEASE_SUPPORT = GERAN_R5_SUPPORT
  # Description:
...
UMTS_TDD128_RF_MODULE = MT6168RF_UMTS_TDD_RF9810
  # Description:
  #   Modem Capability
  # Option Values:
  #   NA: the RF module used in this project
...
# *************************************************************************
RELEASE_PACKAGE		= REL_SUB_L4	# REL_CR_MMI_GPRS, REL_CR_MMI_GSM, REL_CR_L4_GPRS, REL_CR_L4_GSM REL_SUB_UAS_UMTS
...
# *************************************************************************
COM_DEFS_FOR_MT6168_2G_SINGLE = MT6168_2G_RF MT6168_2G_SINGLE
COM_DEFS_FOR_MT6168RF_UMTS_TDD_RF9810 = MT6168_RF
# *************************************************************************
# Include MODEM.mak
# *************************************************************************
...
CUSTOM_OPTION += __UMTS_TDD128_SNIFFER__ __TST_SP_LOGGING_NCB_OPT__

CUSTOM_OPTION += __CUST_TDD_SIG_LEVEL__ __OP01_3G__

CUSTOM_OPTION += __UMAC_DCH_LISR__ __GEMINI_3G_SWITCH__ 

CUSTOM_OPTION += __ADD_MEAS_FREQ_NUM__ __PREPARE_TX_AHEAD__
...
CUSTOM_OPTION += __AST_TRACE_TST_ENABLE__ __NVRAM_IMPORTANT_PARTITIONS__
