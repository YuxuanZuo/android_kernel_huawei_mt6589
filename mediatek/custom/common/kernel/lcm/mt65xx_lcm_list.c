...
extern LCM_DRIVER nt35590_hd720_dsi_cmd_truly_lcm_drv;
...
extern LCM_DRIVER nt35590_hd720_dsi_vdo_truly_fwvga_lcm_drv;

extern LCM_DRIVER hx8369_dsi_6575_fwvga_lcm_drv;
extern LCM_DRIVER nt35516_qhd_dsi_cmd_tianma_lcm_drv;
extern LCM_DRIVER otm8009a_fwvga_lcm_drv;
...
#if defined(NT35590_HD720_DSI_VDO_TRULY_FWVGA)
	&nt35590_hd720_dsi_vdo_truly_fwvga_lcm_drv, 
#endif
...
#if defined(NT35590_HD720_DSI_CMD_TRULY)
	&nt35590_hd720_dsi_cmd_truly_lcm_drv, 
#endif
...
#if defined(NT35516_QHD_DSI_CMD_TIANMA)
  &nt35516_qhd_dsi_cmd_tianma_lcm_drv,
#endif
#if defined(BP101WX1)
  &bp101wx1_lcm_drv,
#endif
...
#endif
#if defined(HX8369_6575_DSI_FWVGA)
  &hx8369_dsi_6575_fwvga_lcm_drv,
#endif
#if defined(OTM8009A_FWVGA)
  &otm8009a_fwvga_lcm_drv,
#endif
};
