...
#else
    pSensorResolution->SensorPreviewWidth	= S5K4E1GA_IMAGE_SENSOR_PV_WIDTH; //S5K4E1GAMIPI_REAL_PV_WIDTH;
    pSensorResolution->SensorPreviewHeight	= S5K4E1GA_IMAGE_SENSOR_PV_HEIGHT; //S5K4E1GAMIPI_REAL_PV_HEIGHT;
#endif
    pSensorResolution->SensorFullWidth		= S5K4E1GA_IMAGE_SENSOR_PV_WIDTH; //S5K4E1GAMIPI_REAL_CAP_WIDTH;
    pSensorResolution->SensorFullHeight		= S5K4E1GA_IMAGE_SENSOR_PV_HEIGHT; //S5K4E1GAMIPI_REAL_CAP_HEIGHT;
    return ERROR_NONE;
...
{
    //Avoid 5M capture, to be fix later
#if defined( S5K4E1GA_1M_SIZE_PREVIEW )
    switch(ScenarioId){
    case MSDK_SCENARIO_ID_CAMERA_ZSD:
        pSensorInfo->SensorPreviewResolutionX= S5K4E1GA_IMAGE_SENSOR_PV_WIDTH; //S5K4E1GA_IMAGE_SENSOR_FULL_WIDTH;
        pSensorInfo->SensorPreviewResolutionY=S5K4E1GA_IMAGE_SENSOR_PV_HEIGHT ;//S5K4E1GAMIPI_REAL_CAP_HEIGHT;
    ...
    pSensorInfo->SensorCameraPreviewFrameRate=15;
#endif
    pSensorInfo->SensorFullResolutionX= S5K4E1GA_IMAGE_SENSOR_PV_WIDTH;
    pSensorInfo->SensorFullResolutionY= S5K4E1GA_IMAGE_SENSOR_PV_HEIGHT;
    spin_lock(&s5k4e1gamipiraw_drv_lock);
