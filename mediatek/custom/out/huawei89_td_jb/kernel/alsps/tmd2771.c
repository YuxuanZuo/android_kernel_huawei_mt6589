...
static int tmd2771_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	int err = 0;
    min_proximity_value = TMD2771_G520_MIN_PRO_VALUE;
    pwin_value = TMD2771_G520_PWINDOWS_VALUE;
    pwave_value = TMD2771_G520_PWAVE_VALUE;
    ps_cali.valid = 1;
    /* modify the als_ps sensor parameter */
    ps_cali.close = 960;
    ps_cali.far_away = 960 -TMD2771_G520_PWINDOWS_VALUE ;
    scacle_factor_vasible = 24;
    scacle_factor_ir = 6;
    TMD2771_CMM_PPCOUNT_VALUE = TMD2771_G520_CMM_PPCOUNT_VALUE;
